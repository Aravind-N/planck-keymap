...
[1] = KEYMAP(
  ...
  LSHIFT, F7,     F8,    F9,  F10, F11, F12,TRNS, TRNS,  TRNS, SLSH,
  TRNS,   MPRV,  MPLY, MNXT, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS ),
[2] = KEYMAP(
  GRV,   TRNS, UP,   TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, BSLS,
  CAPS,   LEFT, DOWN, RIGHT,TRNS, TRNS, INS,  HOME, PGUP, RBRC, QUOT,
